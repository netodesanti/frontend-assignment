      ...
      <div className="relative pt-16">
        ...
        <div className=" mx-auto  ">
          ...
          <div className="bg-black bg-opacity-95 ">
            <div className="max-w-7xl relative px-5 py-16  sm:px-6  mx-auto ">
              <div className="">
                <div className="text-xl text-gray-300 tracking-[-0.02em]">Select Two Assets</div>
                <div className="text-xs leading-5 font-medium currentColor text-gray-500 lg:w-3/5">
                  Please select the two assets that this pool will consist of. When creating a pair, you are the first
                  liquidity provider. Please note that the ratio of tokens you add will set the price of this pool.
                </div>
              </div>
              <div className="mt-5">
                <div className="bg-gray-900 p-3 rounded-2xl lg:w-1/2">
                  <div className="flex justify-between">
                    ...
                    <div className="flex">
                      <div className="text-gray-300 mt-2 text-xs mr-2">Pay from</div>
              ...
              <div className="mt-10">
                <div className="text-xl text-gray-300 tracking-[-0.02em]">Select Fee Tier</div>
                <div className="text-xs leading-5 font-medium currentColor text-gray-500 lg:w-3/5">
                  Select the percentage of fee that this pool will take from a swap order. Higher fee tiers suit pairs
                  with more volatility and less volume.
                </div>
              </div>
              <div className="mt-10 ">
              ...
              <div className="mt-10">
                <div className="text-xl text-gray-300 tracking-[-0.02em]">Create Oracle for this Pair?</div>
                <div className="text-xs leading-5 font-medium currentColor text-gray-500 lg:w-3/5">
                  Creating oracle enables the pool to store its price data and provides more accurate swap rate.
                  However, the swap gas fee will be higher.
                </div>
              </div>
              <div className="mt-10">
                <div className={WalletButtonShow ? 'hidden' : 'mt-1'}>
                  <button
                    ...
                    className="px-12 py-1.5 rounded-lg bg-blue-500"
                  >
                    Connect Wallet
                  </button>
                </div>
