  ...
  if (AccountChooseValueType === 1) {
        ...
        <div>
            ...
            <div className="ml-4 flex-col justify-between">
              ...
              <Link passHref href={`https://explorer-devnet.web3games.org/address/${intactWalletAddress}`}>
                ...
                <div className="ml-1 text-xl">
                  <i className="fa fa-link transform rotate-90" aria-hidden="true"></i>
                </div>
                {/* </a> */}
              </Link>
              <div>
                <button
                  ...
                  className="text-gray-400 font-light flex transition duration-300"
                >
                  <div className="hidden" id="address">
                    {intactWalletAddress}
                  </div>
                  <div id="address">{walletAddress}</div>
          ...
          <div className="lg:flex justify-between text-gray-400 mt-5">
            <div>
              ...
              <div className="text-2xl text-gray-100">$0.00</div>
            </div>
            <div className="mt-5 lg:mt-0 flex ">
              <div className="mr-10">
                <div className="text-sm"> Available </div>
                <div className="text-gray-200 text-xl font-light">$0.00</div>
              </div>
              <div className="mr-10">
              ...
              <div>
                ...
                <div className="text-gray-200 text-xl font-light">1</div>
              </div>
            </div>
          </div>
        </div>
    ...
    return (
      <div>
        <div className="flex">
          <img className="w-16 rounded-full border border-gray-600" src="/img.png" alt="" />
          <div className="ml-4 flex-col justify-end"></div>
        </div>
        <div className="lg:flex justify-between text-gray-400 mt-5">
          <div>
            <div className="text-sm"> Net Worth </div>
          ...
          <div className="mt-5 lg:mt-0 flex ">
            ...
            <div className="mr-10">
              <div className="text-sm"> Temporarily Unavailable </div>
              <div className="text-gray-200 text-xl text-center font-light">$0.00</div>
            </div>
            <div>
              <div className="text-sm"> Assets </div>
              <div className="text-gray-200 text-xl font-light">0</div>
            </div>
          </div>
        </div>
      </div>
...
const AssetsWallet = () => {
  ...
  return (
    <>
      <div className="my-20 ">
        <div>
          <div className="text-white text-xl">Chain Wallet</div>
                ...
                <tbody className={walletInfo.length ? 'divide-y  divide-gray-800  ' : 'hidden'}>
                  {walletInfo.map(item => (
                    <tr
                      key={item.id}
                      onClick={openassets}
                      className="hover:bg-gray-800 bg-opacity-80  cursor-pointer transition duration-300 "
                    >
                      <td className="px-6 py-4  whitespace-nowrap text-sm text-white">
                        <div className="flex ">
                          ...
                          <div className="ml-2  ">
                            <div>W3G</div>
                            <div className="text-gray-400 ">{item.assets}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6  py-1  whitespace-nowrap text-base text-white ">{item.balance}</td>
                      <td className="px-6  py-1  whitespace-nowrap text-base text-white ">{item.locked}</td>
              ...
              <div className="inline-block align-bottom bg-gray-900 lg:w-3/12  rounded-lg px-4 py-5 text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle  sm:px-6 lg:px-12 ">
                <div>
                  <div className="flex justify-between text-xl font-light text-white 	mb-5">
                    <div className=" font-light  text-xl ">Available actions</div>
                    <button onClick={() => setSelectopen(false)} className="fa fa-times " aria-hidden="true"></button>
                  </div>
                  <div className="my-5 ">
                    <Link passHref href="/home">
                      ...
                      <div className="text-gray-500 p-3 mb-4 border border-gray-600 rounded-xl flex">
                        ...
                        <div className="text-sm mt-1 text-gray-200 font-semibold">Swap W3G</div>
                      </div>
                      {/* </a> */}
                    </Link>
                    ...
                    <Link passHref href="/transfer">
                      ...
                      <div className="text-gray-500 p-3  mb-4 border border-gray-600 rounded-xl flex">
                        ...
                        <div className="text-sm mt-1 text-gray-200 font-semibold">Transfer</div>
                      </div>
                      {/* </a> */}
                    </Link>
                    <Link passHref href="/transaction">
                      ...
                      <div className="text-gray-500 p-3  mb-4 border border-gray-600 rounded-xl flex">
                        ...
                        <div className="text-sm mt-1 text-gray-200 font-semibold">Transaction</div>
                      </div>
                      {/* </a> */}
                    </Link>
                  </div>
