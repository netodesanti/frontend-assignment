...
const from = [
  {
    ...
    name: 'Web3Games',
    avatar:
      'data:img/jpg;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAIAAAAiOjnJAAANrklEQVR4nOzdf2xT1fsH8LW1rCys\n' +
        ...
        <div className=" mx-auto  ">
          <div className="bg-black bg-opacity-95 ">
            <div className="max-w-7xl relative px-5 py-16  sm:px-6  mx-auto ">
              <div className="text-white text-center text-3xl font-semibold">Connect your wallets to get started.</div>
                ...
                <div className="bg-black bg-opacity-90 p-5 rounded-2xl w-full md:w-1/2">
                  <div className="p-2 md:p-5">
                    ...
                    <div className="flex justify-end text-gray-400 text-sm font-semibold mt-2">
                      <div>
                        Available Balance:
                        <div className="flex justify-end">0 {swapTokenTop.name}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-10">
                    <div className={WalletButtonShow ? 'hidden' : 'mt-8  flex justify-center'}>
                      <button
                        ...
                        className="px-12 py-1.5 rounded-lg bg-[#2C2C2C] text-white"
                      >
                        Connect Wallet
                      </button>
                    </div>
              ...
              <div className="text-white flex  justify-center w-full md:w-1/2 mx-auto px-4 mt-5 text-xs md:text-sm  sm:px-4">
                <div className="w-full">
                  ...
                  <div className="flex justify-between items-center">
                    <div>Fee</div>
                    <div className="flex items-center justify-end">0.000006</div>
                  </div>
                  <div className="flex justify-between items-center">
                    <div>Estimated time of arrival</div>
                    <div className="flex items-center justify-end ">5~20 mins</div>
                  </div>
                  <div className="flex justify-between items-center">
                    <div>Min. amount greater than</div>
                    <div className="flex items-center justify-end  ">0.01 W3G</div>
                  </div>
                  <div className="flex justify-between items-center">
                    <div>Max. amount less than</div>
                    <div className="flex items-center justify-end ">25,000 W3G</div>
                  </div>
                  <div className="flex justify-between items-center">
