                ...
                <div className=" p-5 ">
                  <div className="rounded-2xl border mb-5 border-gray-500 p-4">
                    <div className="flex justify-between mb-5">
                      <div className="text-gray-200 text-sm  ">APR</div>
                      <div className="text-indigo-500 flex font-semibold">9.82%</div>
                    </div>
                    <div className="flex justify-between">
                      <div className="text-gray-200 text-sm ">Liquidity</div>
                      <div className="text-white flex font-semibold">$56,112,781</div>
                    </div>
                  </div>

                  <div className="rounded-2xl border border-gray-500 p-4">
                    <div className=" mb-2">
                      <div className="text-gray-200 text-sm   mb-1">Earned</div>
                      <div className="text-white flex font-semibold">0 W3G</div>
                    </div>
                    <div className="">
                      <div className="text-gray-200 text-sm mb-1">Staked W3G</div>
                      <div className="text-white flex font-semibold">0 W3G</div>
                    </div>
                  </div>
                  <div className="flex justify-center mt-6 text-gray-200">
                    <div className="flex">
                      <div className="">Loyalty program ends in:</div>
                  ...
                  <div className="text-center mt-5 ">
                    ...
                    <div className={WalletButtonShow ? 'mt-1' : 'hidden'}>
                      <button
                        ...
                        className="px-12 py-1.5 rounded-lg bg-indigo-500"
                      >
                        Stake / Unstake
                      </button>
                    </div>
                    ...
                    {({ open }) => (
                      <>
                        <Disclosure.Button className="flex justify-center w-full px-4 py-2 text-sm  mt-5 border-t border-gray-600 text-indigo-400   ">
                          <span className={open ? 'hidden' : ''}>Details</span>
                          <span className={open ? '' : 'hidden'}>Hide</span>
                          <ChevronDownIcon
                        ...
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-200">
                          ...
                          <div className="border p-5 mt-2 text-center rounded-2xl">
                            ...
                            <div className="text-white text-xl mt-2 font-semibold">0 W3G</div>
                            ...
                            <div className="text-center mt-5 ">
                              ...
                              <div className={WalletButtonShow ? 'mt-1' : 'hidden'}>
                                <button className="px-12 py-1.5 rounded-lg bg-indigo-500">Claim</button>
                              </div>
                            </div>
                          </div>
                        </Disclosure.Panel>
                ...
                >
                  <div className="inline-block  align-bottom bg-gray-900 text-white rounded-lg py-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle   sm:py-6 ">
                    <div>
                      ...
                      <div className="flex justify-start text-xl font-bold  px-8 py-3 w-96  sm:mr-32">W3G</div>
                        ...
                        <div className="mt-5">
                          ...
                          <div className="flex mt-5">
                            ...
                            <div className=" flex -ml-24 mt-2 z-20">
                              <div>
                                <button className="text-indigo-400 font-semibold mr-3">MAX</button>
                              </div>
                          ...
                          <div className="rounded-2xl mt-5 border border-gray-500 p-3">
                            <div className="flex justify-between ">
                              <div className="text-gray-200 flex items-center    ">Earned</div>
                              <div className="text-white flex font-semibold">0 ACA</div>
                            </div>
                          </div>
                          <button className="mt-5 text-center  w-full py-1.5 rounded-xl bg-indigo-500 ">Stake</button>
                        </div>
                        <div className="my-8">
                          <div className="flex my-3 justify-between ">
                            Staked Balance
                          ...
                          <button className="mt-5 text-center  w-full py-1.5 rounded-xl bg-indigo-500 ">Unstake</button>
                        </div>
                      </div>
                    </div>
                  </div>
