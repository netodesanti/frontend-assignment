      ...
      <div>
        <div className="xl:flex">
          ...
          <div className="xl:ml-10 xl:w-2/3 mt-10 xl:mt-0">
            ...
            <div className="text-2xl md:text-4xl text-white font-semibold">{info.title}</div>
            <div className="flex mt-4 justify-between md:w-3/5">
              <div className="flex ">
                ...
                <div className="ml-2">
                  ...
                  <div className="text-white text-sm">{info.creator}</div>
                </div>
              </div>
              <div className="">
                <div className="text-gray-400 text-sm">Owner</div>
                <div className="text-white text-sm">{info.onwner}</div>
              </div>
              <div className="">
                <div className="text-gray-400 text-sm">Type</div>
                <div className="text-white text-sm">{info.type}</div>
              </div>
            </div>
            <div className="text-gray-300 font-light my-10">{info.h1}</div>
  ...
  return (
    <>
      <div className="mt-10  bg-neutral-800 rounded-xl">
        <div className="text-white px-6 p-4 font-semibold text-lg border-b border-gray-500">About Collection</div>
        <div className="p-2 mt-5">
          <img className="w-16 rounded-full mx-auto" src={info.img} alt="" />
          <div className="px-4 text-center text-sm text-gray-400 mt-4">{info.h1}</div>
        </div>
      </div>
    </>
  );
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className="flex justify-between w-full bg-neutral-800 px-4 py-3 text-sm font-medium text-left text-white rounded-lg ">
                ...
                <ChevronUpIcon className={`${open ? '' : 'transform rotate-180'} w-5 h-5 text-gray-300`} />
              </Disclosure.Button>
              <Transition
                as={Fragment}
                  ...
                  <div className="grid grid-cols-2 gap-3 ">
                    {info.map(item => (
                      <div key={item.part} className="text-center p-2 bg-indigo-700 rounded-xl ">
                        <div className="text-red-300 text-sm">{item.part}</div>
                        <div className="text-white  font-semibold">{item.style}</div>
...
const AssetLeftDetail = () => {
  ...
  return (
    <>
      <div className="mt-10 bg-neutral-800 rounded-xl">
        <div className="text-white px-6 p-4 font-semibold text-lg border-b border-gray-500">Detail</div>
        <div className="p-2 ">
          <div className="px-4 text-center text-sm text-gray-400 ">
            <div className="flex py-3 justify-between">
              ...
              <Link passHref href="/#">
                {/* <a> */}
                <div className="text-red-400 font-semibold">{info.address}</div>
                {/* </a> */}
              </Link>
            </div>
            <div className="flex py-3 justify-between">
              <div className="font-semibold">Token ID</div>
              <div className="font-semibold">{info.token}</div>
            </div>
            <div className="flex py-3 justify-between">
              <div className="font-semibold">BlockChain</div>
              <div className="font-semibold">{info.blockchain}</div>
            </div>
            <div className="flex py-3 justify-between">
              <div className="font-semibold">Metadata</div>
              <Link passHref href="/#">
                {/* <a> */}
                <div className="text-red-400 font-semibold">{info.meta}</div>
                {/* </a> */}
              </Link>
            </div>
          </div>
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className="flex justify-between w-full bg-neutral-800 px-4 py-3 text-sm font-medium text-left text-white rounded-lg ">
                ...
                <ChevronUpIcon className={`${open ? '' : 'transform rotate-180'} w-5 h-5 mt-1 text-gray-300`} />
              </Disclosure.Button>
              <Transition
                as={Fragment}
                enter="transition ease-out duration-300"
                      ...
                      <table className="min-w-full divide-y divide-neutral-700 mb-4">
                          ...
                          <tr>
                            {listTitle.map(item => (
                              <th
                                ...
                                className={
                                  listInfo.length
                                    ? 'px-6  py-2 text-left  text-sm  md:font-semibold text-gray-300'
                                    : 'px-2 py-2 text-left  text-sm  md:font-semibold text-gray-300'
                                }
                              >
                                {item.name}
                              </th>
                        ...
                        <tbody className={listInfo.length ? 'divide-y divide-gray-200' : 'hidden'}>
                          {listInfo.map(item => (
                            <tr
                              key={item.id}
                              className="hover:bg-neutral-600 bg-opacity-80 bg-neutral-700 cursor-pointer transition duration-300 "
                            >
                              <td className="px-6 py-4  whitespace-nowrap text-sm text-white">{item.price}</td>
                              <td className="px-6 py-4   whitespace-nowrap text-sm text-white">{item.usd}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-white">{item.expiration}</td>
                        ...
                        <tbody className={historyInfo.length ? 'divide-y divide-gray-200' : 'hidden'}>
                          {historyInfo.map(item => (
                            <tr
                              ...
                              className="hover:bg-neutral-600 bg-opacity-80 bg-neutral-700 cursor-pointer transition duration-300 "
                            >
                              <td className="px-6 py-4  whitespace-nowrap text-sm text-white">{item.event}</td>
                              <td className="px-6 py-4   whitespace-nowrap text-sm text-white">
                                <div className="flex">
                                  <img className="w-6 rounded-full border border-gray-600" src="/img.png" alt="" />
                                  <div className="ml-1 mt-0.5">{item.price}</div>
                                </div>
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-white">
                                <Link passHref href="/#">
                              ...
                              <td className="px-6  py-4  whitespace-nowrap text-base text-red-500">{item.date}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
