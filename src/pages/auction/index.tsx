            ...
            <div className="max-w-5xl relative px-5 py-16  sm:px-6  mx-auto ">
              <div className="md:mx-20">
                <div className="text-center">
                  <div className="text-xl md:text-3xl text-indigo-500 font-semibold">W3G NFT Auction</div>
                  <div className=" text-white font-semibold">Collect W3G NFTs and connect with W3G Future!</div>
                  <div className="text-sm md:text-base text-gray-200">
                    When entering the auction, you must bid 5% above the current price. Proceeds from the auction will
                    be distributed to users, the artist and past NFT Holders. Come be apart of the bid wars!
                  </div>
                </div>
              </div>
              <div className="mt-20 ">
                        ...
                        <div className="bg-gray-100 opacity-90 px-6 lg:px-10 rounded-b-xl py-4 flex justify-between">
                          <div>
                            <div className="flex md:inline-block">
                              <div className="text-sm md:text-base">Distribution</div>
                            ...
                            <div className="md:flex text-xs text-sm">
                              <div className="flex md:mr-10">
                                Total Volume:
                                <div className="text-indigo-400 ml-1">{item.total}</div>
                              </div>
                              <div className="flex">
                                Floor Price:
                                <div className="text-indigo-400 ml-1"> {item.floor}</div>
                              </div>
                            </div>
                          </div>
                          <div className="flex">
