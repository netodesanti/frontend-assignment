    ...
    <div className="bg-W3GBG px-4 md:px-10 xl:px-0">
      <div className="text-white py-32">
        <div className=" max-w-7xl mx-auto">
                ...
                <div className="mb-6">
                  <div className="flex xl:block">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400  mt-2">{show_project.project_h1}</div>
                    </div>
                  </div>
                  <div className="flex justify-between p-2 pr-4 items-center my-2 bg-[#313543] rounded-md">
                    <div className="text-xs md:text-sm">0xuhdnUBY049520n9c28fh489ndnX8s034hk234</div>
                    <div>
              ...
              <div className="z-10 xl:w-6/12">
                <div className=" xl:bg-[#3E4459]/40 rounded-xl xl:p-4 xl:shadow-2xl  ">
                  ...
                  <div className="flex  text-sm mt-2 xl:mt-4 justify-center md:justify-start ">
                    <div className="text-gray-400">Enrollment closes:</div>
                    <div className="ml-1">15 Jul 2022 18:00, +08:00</div>
                  </div>
                  <Tab.Group>
                    ...
                    <Tab.Panels className="mt-2 ">
                      <Tab.Panel className={classNames(' rounded-xl md:p-1  w-full ')}>
                        <div className="rounded-lg bg-[#313543] p-4">
                          <div className="text-sm">Swap currency</div>
                          <div className="flex justify-between  items-center my-1">
                            ...
                            <div className="flex ">
                              <div className="rounded-lg py-1 px-1 md:px-3 text-blue-400 bg-[#616884] mr-2">MAX</div>
                              <div className="rounded-lg py-1 px-1 md:px-3 text-blue-400 bg-[#616884]">Swap</div>
                            </div>
                          </div>
                          <div className="flex justify-between text-sm mt-2">
                            <div>Rate</div>
                            <div className="flex">1 MYRA = 1.0000USDT.e</div>
                          </div>
                        </div>
                      </Tab.Panel>
                      {/*Popular*/}
                      <Tab.Panel className={classNames('text-gray-300 rounded-xl md:p-1 ')}>
                        <div className="rounded-lg bg-[#313543] p-4">
                          <div className="text-sm">Claim your MYRA tokens</div>
                  ...
                  <div className="flex text-sm mt-4 items-center justify-center md:justify-start">
                    ...
                    <div className="text-gray-400 mr-0.5">Token Claim Date:</div>
                    <div>08 Aug 2022 18:00, +08:00</div>
                  </div>
                </div>
                <div></div>
              </div>
          ...
          <div>
            <div className="mt-10 text-2xl ">Details</div>
                ...
                <dl className="sm:divide-y sm:divide-[#313543] text-left">
                  ...
                  <div className="py-4 flex justify-between  sm:py-5 sm:px-6 xl:px-12">
                    ...
                    <dd className="text-sm text-gray-400 flex items-center">
                      <div className="mr-1">USDT.e 1.0000</div>
                      <i className="fa fa-external-link" aria-hidden="true"></i>
                    </dd>
                  </div>
                  <div className="py-4 flex justify-between  sm:py-5 sm:px-6 xl:px-12">
              ...
              <div className="border-t border-[#313543] px-4 py-5 sm:p-0">
                <dl className="divide-y divide-[#313543] text-left">
                  ...
                  <div className="py-4 flex justify-between  sm:py-5 sm:px-6 xl:px-12">
                    ...
                    <dd className="text-sm text-gray-400 flex items-center">
                      <div className="mr-1">0x765...234</div>
                      <i className="fa fa-external-link" aria-hidden="true"></i>
                    </dd>
                  </div>
                  <div className="py-4 flex justify-between  sm:py-5 sm:px-6 xl:px-12">
