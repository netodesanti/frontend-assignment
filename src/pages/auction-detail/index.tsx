    ...
    <>
      <div className="p-2 rounded-xl bg-gray-700 md:w-8/12">
        ...
        <div className="mt-5 text-sm mx-3">
          <div className={classNames(ListStateStyle[detailLife.state], 'text-white font-semibold')}>Closed</div>
          <div className="flex justify-between text-white mt-3 py-2 ">
            <div>
              <div className="text-center">{detailLife.days}</div>
              <div className="text-gray-400">Days</div>
            </div>
            <div>
              <div className="text-center">{detailLife.hours}</div>
              <div className="text-gray-400">Hours</div>
            </div>
            <div>
              <div className="text-center">{detailLife.minutes}</div>
              <div className="text-gray-400">Minutes</div>
            </div>
            <div>
              <div className="text-center">{detailLife.seconds}</div>
    ...
    <>
      <div className="mt-5 md:mt-0 md:ml-8 text-white w-11/12 ">
        ...
        <div className="flex text-sm w-40 p-1 px-1.5 mt-2 rounded-md bg-pink-500">
          <div>Already did</div>
          <div className="mx-1">{detailRight.frequency}</div>
          <div>times</div>
        </div>
        <div className="mt-3 text-sm  text-gray-400 h-20 overflow-hidden mb-1">{detailRight.h1}</div>
        <div className="text-sm ">
          <div className="flex mb-5 ">
            <div className="text-gray-300">Current prices：</div>
            <div className="flex">
              <img className="rounded-full w-6 border border-gray-600 mr-2" src="/img.png" alt="" />
              <div>{detailRight.current}</div>
            </div>
          </div>
          <div className="flex mb-5 ">
            <div className="text-gray-300">Highest bidder account:</div>
            <div className="truncate ml-1.5 w-28  ">{detailRight.bidderAccount}</div>
          </div>
          <div className="flex mb-2 ">
            <div className="text-gray-300">ETH Address：</div>
          ...
          <div className="flex mb-5 ">
            <div className="mr-16 mt-6 text-gray-300">My bid:</div>
            <div className="text-right text-xs ">
              <button className="text-blue-400 mr-3">Click here to bid the minimum</button>
