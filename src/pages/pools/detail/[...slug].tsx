                ...
                <Tab
                  className={({ selected }) =>
                    classNames(
                      ...
                      selected ? ' text-white   border border-gray-300  ' : '  hover:text-white ',
                    )
                  }
                >
...
const Detail = () => {
  ...
  useEffect(() => {
    if (router.isReady) {
      const token_detail = async () => {
        ...
        const user_lp_token_balance_result: any = await api.query.tokenFungible.balances(
          pair_lp_token_address,
          intactWalletAddress,
        );
        ...
        setTokenAccountABalance(
          parseFloat(String(cropData(Number(account_token_a_balance.toString() / baseNumberA), 4))),
        );
        setTokenAccountBBalance(
          parseFloat(String(cropData(Number(account_token_b_balance.toString() / baseNumberB), 4))),
        );
    ...
    if (e.target.value !== '') {
      ...
      if (!result) {
        ...
        time = setTimeout(async () => {
          ...
          let token_b_real_result = Number(
            await substrate_EstimateOutToken(intactWalletAddress, token_a_real, token_a, token_b),
          );
          ...
          const lp_number = await substrate_getEstimateLpToken(
            intactWalletAddress,
            token_a,
            token_a_real,
            token_b,
  ...
  const addLiquidity = async () => {
    if (amount_b_number <= Number(tokenBAccountBalance)) {
      ...
      const transferExtrinsic = api.tx.exchange.addLiquidity(
  ...
  const removeLiquidity = async () => {
    ...
    const transferExtrinsic = api.tx.exchange.removeLiquidity(
      PoolDetails.assets_b_id,
      PoolDetails.assets_a_id,
      token_c_real,
      0,
                  ...
                  <div className="p-0.5 rounded-lg bg-gradient-to-br from-W3G1 via-W3G2  to-W3G3  h-full xl:w-4/12">
                    <div className="bg-[#151515]  p-5 rounded-lg  w-full">
                      ...
                      <div className="flex justify-between bg-[#2B2B2B] rounded-md p-1 items-center">
                        ...
                        <div className="text-white">{tokenABalance}</div>
                      </div>
                      <div className="flex mt-4 justify-between bg-[#2B2B2B] rounded-md p-1 items-center">
                        ...
                        <div className="text-white">{tokenBBalance}</div>
                      </div>
                      <div className="flex justify-between my-5 ">
                        <div className="border border-[#8E6CCD] rounded-full text-white py-0.5  px-2 text-sm ">
                          1 {PoolDetails.assets_a} ≈ {cropData(Number(tokenBBalance) / Number(tokenABalance), 2)}{' '}
                          {PoolDetails.assets_b}
                        </div>

                        <div className="border border-[#8E6CCD] rounded-full text-white py-0.5 px-2 text-sm">
                          1 {PoolDetails.assets_b} ≈ {cropData(Number(tokenABalance) / Number(tokenBBalance), 2)}{' '}
                      ...
                      <div className=" pt-5">
                        <div className="flex justify-between items-center">
                          ...
                          <div className=" border-[#8E6CCD] border text-white text-sm px-1 rounded-md">0.3%</div>
                        </div>

                        <div className="flex justify-between mt-4">
                          <div className="text-gray-400">TVL</div>
                          <div className="text-white text-sm px-1">$ {PoolDetails.tvl}M</div>
                        </div>

                        <div className="flex justify-between mt-4">
                          <div className="text-gray-400">24h Volume</div>
                          <div className="text-white text-sm px-1">{PoolDetails.volume_days}</div>
                        </div>

                        <div className="flex justify-between mt-4">
                          <div className="text-gray-400">Total LP Token</div>
                          <div className="text-white text-sm px-1">{PoolDetails.total_lp}</div>
                        </div>
                  ...
                  <div className=" xl:w-9/12 mt-5 xl:ml-8  xl:mt-0">
                    <div className="flex justify-center xl:justify-end">
                      ...
                      <button
                        ...
                        className="ml-5 lg:mt-0  px-8 py-2 rounded-lg bg-gradient-to-r from-W3G1 via-W3G2  to-W3G3 text-white"
                      >
                        Remove Liquidity
                      </button>
                    </div>
                  ...
                  <div className="inline-block align-bottom p-0.5 rounded-lg bg-gradient-to-br from-W3G1  via-W3G2 to-W3G3 w-11/12 md:w-9/12 xl:w-6/12 2xl:w-4/12  rounded-lg  text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle   ">
                    <div className="bg-black px-4 py-5 sm:px-6 lg:px-12 rounded-md">
                          ...
                          <div className="items-center">
                            ...
                            <div className="flex mx-4">
                              <input
                                ...
                                placeholder="0"
                                maxLength={14}
                                onInput={e => checkNumber_token_a(e, PoolDetails.assets_a_id, PoolDetails.assets_b_id)}
                              ...
                              />
                              <button
                                onClick={() => max_balance_a(PoolDetails.assets_a_id, PoolDetails.assets_b_id)}
                                className="rounded-lg py-1 px-5 ml-2 bg-gradient-to-r from-W3G1 via-W3G2 to-W3G3 text-sm flex items-center  text-white "
                              >
                                MAX
                              </button>
                            </div>
                            ...
                            <div className="flex mx-4">
                              <input
                                ...
                                className={classNames(
                                  tokenABalance == '0' && tokenBBalance == '0' ? 'xl:w-44' : 'xl:w-64 ',
                                  'text-xs md:text-sm placeholder-gray-500 bg-[#1F1F1F] rounded-lg p-2 py-3 text-white border border-W3GInfoBG   hover:border-neutral-600 focus:border-neutral-600  transition duration-300    outline-none',
                                )}
                                placeholder="0"
                              ...
                              />
                              <button
                                onClick={max_balance_b}
                                className={classNames(
                                  tokenABalance == '0' && tokenBBalance == '0' ? '' : 'hidden',
                                  'rounded-lg py-1 px-5 ml-2 bg-gradient-to-r from-W3G1 via-W3G2 to-W3G3 text-sm flex items-center  text-white ',
                                )}
                              >
                                MAX
                              </button>
                      ...
                      <div className="mt-5 flex justify-between mx-4">
                        <div className="text-gray-600">LP Tokens</div>
                        <div className="text-white">{yourLP}</div>
                      </div>
                      <div className="text-center mt-5">
                        <div className={WalletButtonShow ? 'hidden' : 'mt-1'}>
                          <button
                            ...
                            className="w-full py-1.5 text-gray-200 rounded-lg bg-blue-500"
                          >
                            Connect Wallet
                          </button>
                        </div>
                        <div className={WalletButtonShow ? 'mt-1' : 'hidden'}>
                          <div className={requestData ? 'hidden' : ''}>
                            <button
                              className={
                                amount_b_number > Number(tokenBAccountBalance)
                                  ? 'lg:mt-0  w-56 px-3 py-2 rounded-lg bg-gradient-to-r from-W3G1/60 via-W3G2/60 to-W3G3/60 text-gray-400 cursor-not-allowed'
                                  : 'hidden'
                              }
                            >
                              Add Liquidity
                            ...
                            <button
                              id="add_liquidity_button"
                              onClick={addLiquidity}
                              className={
                                amount_b_number > Number(tokenBAccountBalance)
                                  ? 'hidden'
                                  : 'lg:mt-0  w-56 px-3 py-2 rounded-lg bg-gradient-to-r from-W3G1 via-W3G2 to-W3G3 text-white'
                              }
                            >
                              Add Liquidity
                            </button>
                          ...
                          <button
                            className={classNames(
                              requestData ? 'from-W3G1/60 via-W3G2/60 to-W3G3/60 cursor-not-allowed' : 'hidden',
                  ...
                  <div className="inline-block align-bottom p-0.5 rounded-lg bg-gradient-to-br from-W3G1  via-W3G2 to-W3G3 w-11/12 md:w-9/12 xl:w-1/3 xl:w-1/4  rounded-lg  text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle   ">
                    <div className="bg-black px-4 py-5 sm:px-6 lg:px-12 rounded-md">
                      ...
                      <div className="mt-5 flex justify-between items-center">
                        <div className="text-gray-500">Slippage tolerance</div>
                      ...
                      <div className="text-center mt-5">
                        ...
                        <div className={WalletButtonShow ? 'mt-1' : 'hidden'}>
                          <button
                            ...
                            className=" lg:mt-0  w-56 px-3 py-2 rounded-lg bg-gradient-to-r from-W3G1 via-W3G2  to-W3G3 text-white"
                          >
                            Remove Liquidity
                          </button>
                        </div>
