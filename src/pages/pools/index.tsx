...
const Pools = () => {
      ...
      const query_token_balance = async () => {
        if (AccountChoose == 2) {
          ...
          for (let i = 0; i < times; i++) {
            const account_token_balance_result = await api.query.tokenFungible.balances(
              tokenlist[i].tokenId,
              intactWalletAddress_local,
            );
          ...
          } = await api.query.system.account(intactWalletAddress);
          const account_W3G_balance_result = `${previousFree}`;
          const baseNumber = Math.pow(10, 18);
          const W3G_balance_real_number = parseFloat(
            String(cropData(Number(account_W3G_balance_result) / baseNumber, 4)),
          );
          const W3G_info = {
            tokenId: '0',
            img: '/img.png',
  ...
  const createPool = async () => {
    if (swapTokenTop.tokenId === swapTokenTail.tokenId) {
      ...
      const result = await transferExtrinsic
      ...
      <div className=" relative pt-16">
        ...
        <div className=" mx-auto  ">
              ...
              <div className={openAlert ? 'flex fixed z-20   inset-x-0 px-6 pt-4  justify-end ' : 'hidden '}>
                <div className="bg-green-100 rounded-lg py-5 px-4  text-base text-green-700 inline-flex " role="alert">
                  <svg
                    ...
                    className="w-6 h-6 mr-2 mt-1 fill-current"
                    role="img"
                  ...
                  <button
                    ...
                    className="ml-6 text-gray-800 -mt-8"
                  >
                ...
                <div className="mt-10 md:mt-0  text-center">
                  <div className={WalletButtonShow ? 'hidden' : 'mt-1'}>
                    <button
                      ...
                      className="px-12 py-1.5 text-gray-200 rounded-lg bg-[#2C2C2C]"
                    >
                      Connect Wallet
                    </button>
                  </div>
                  <div
                    className={
                      WalletButtonShow
                        ? 'mt-1 p-0.5 rounded-full bg-gradient-to-r from-[#DB5E7F]  via-[#876BD2] to-[#6E93E8]  shadow-xl'
                        : 'hidden'
                    }
                  >
                    <button
                      ...
                      className=" lg:mt-0 bg-black px-24 py-2 rounded-full  text-white font-semibold"
                    >
                      View Pools
                    </button>
                  </div>
          ...
          <div className="max-w-7xl relative px-5 pb-16 pt-4 sm:px-6   mx-auto ">
            <div className="text-white">Liquidity Pools</div>
            {/*Liquidity Pools*/}
            <div className="text-white mt-4 p-5 rounded-lg bg-W3GInfoBG">
              <div className="flex ">
                <div className="text-gray-400 ">My Watchlist</div>
                <div>
                  <i className="fa fa-question-circle ml-2 mt-1.5 text-gray-300" aria-hidden="true"></i>
                </div>
              </div>
                  ...
                  <tbody className="  divide-y divide-W3GInfoBorderBG">
                    {token_watchlist_pool_pair.map(item => (
                      <tr
                        key={item.pool_id}
                        onClick={() => {
                          toDetail(item.assets_a_id, item.assets_b_id);
                        }}
                      ...
                      >
                        ...
                        <td className="px-6 py-4  whitespace-nowrap text-sm text-gray-200">{/*{item.fee}*/} 0.3%</td>
                        <td className="px-6 py-4  whitespace-nowrap text-sm text-gray-200">${item.tvl}M</td>
                        <td className="px-6 py-4  whitespace-nowrap text-sm text-gray-200">{item.pool_id}</td>
                      </tr>
                    ))}
                  </tbody>
            ...
            <div className="text-white mt-10 p-5 rounded-lg bg-W3GInfoBG">
              <div className="md:flex items-center justify-between">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    <div className="text-gray-500 mr-1">Filter by</div>
                  ...
                  <div className="mx-4 hidden md:flex items-center">
                    ...
                    <div className="text-gray-500">Hide low TVL</div>
                  </div>
                  ...
                  <div className="mt-5 ">
                    <div className="flex items-center justify-between mt-4 ">
                      <div className="items-center w-full">
                        <div className="text-gray-400 text-sm mb-2">Token</div>
                          ...
                          <div className="flex bg-[#1F1F1F] p-2 w-full rounded-lg">
                            <div className="flex w-full">
                              <button
                                ...
                                className="flex w-full px-2 items-center justify-between"
                              >
                    ...
                    <div className="items-center w-full mt-10">
                      <div className="text-gray-400 text-sm mb-2">Pair</div>
                      <div className="flex  w-full">
                        <div className="flex bg-[#1F1F1F]  p-2 w-full rounded-lg">
                          <div className="flex w-full">
                            <button
                  ...
                  <div className="text-center mt-7">
                    <div className={WalletButtonShow ? 'hidden' : 'mt-1'}>
                      <button
                        ...
                        className="w-full py-1.5 text-gray-200 rounded-lg bg-[#2C2C2C]"
                      >
                        Connect Wallet
                      </button>
                    </div>
                    <div className={WalletButtonShow ? 'mt-1' : 'hidden'}>
                      <button
                        onClick={createPool}
                        className=" lg:mt-0  w-56 px-3 py-2 rounded-lg bg-gradient-to-r from-[#DB5E7F]  via-[#876BD2] to-[#6E93E8] text-white"
                      >
                        Create
                      </button>
                    </div>
