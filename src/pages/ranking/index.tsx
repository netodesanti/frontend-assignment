            ...
            <div className="max-w-7xl  px-5 py-16  sm:px-6  mx-auto ">
              <div className="text-white max-w-xl xl:max-w-2xl mx-auto">
                ...
                <div className=" mx-auto w-24">
                  <select
                    className="relative  font-bold px-2 py-2.5 outline-none bg-gray-700 rounded-full flex-auto  overflow-ellipsis  focus:placeholder:text-low-emphesis flex-grow  text-left bg-transparent text-inherit disabled:cursor-not-allowed"
                    title="-"
                  >
                      ...
                      {rankings.map(item => (
                        <Link passHref key={item.id} href="/collections">
                          <tr className="hover:bg-gray-800 bg-opacity-80 cursor-pointer transition duration-300 ">
                            <td className="px-2 py-4 whitespace-nowrap text-sm text-white">{item.id}</td>
                            <td className="px-6 py-4  whitespace-nowrap text-sm text-white">
                              <div className="flex">
                                <img className="w-10 rounded-full" src={item.img} alt="" />
                                <div className="w-36 text-xl mt-1 mx-2 text-white">{item.name}</div>
                              </div>
                            </td>
                            <td className="px-6 py-4  whitespace-nowrap text-base text-white">
                              <div className="flex">
                                ...
                                <div className="ml-1">{item.volume}</div>
                              </div>
                            </td>
                            <td
                              className={classNames(
                                rankStyle[item.daystate],
                                'px-6 py-4 whitespace-nowrap text-base text-gray-500',
                              )}
                            >
                              {item.daydata}
                            </td>
                            ...
                            <td className="px-6  py-4  whitespace-nowrap text-base text-white">
                              <div className="flex">
                                <img className="w-6 rounded-full border border-gray-700" src="/img.png" alt="" />
                                <div className="ml-1 w-20">{item.floor}</div>
                              </div>
                            </td>
                            ...
                            <td className="px-6 py-4  whitespace-nowrap text-base text-white">
                              <div className="flex">
                                <img className="w-6 rounded-full border border-gray-700" src="/img.png" alt="" />
                                <div className="ml-1 w-28">{item.avg}</div>
                              </div>
                            </td>
                            <td className="px-6 py-4  whitespace-nowrap text-base text-white">{item.owners}</td>
                            <td className="px-6 py-4  whitespace-nowrap text-base text-white">{item.items}</td>
                          </tr>
                        </Link>
                      ))}
                    </tbody>
