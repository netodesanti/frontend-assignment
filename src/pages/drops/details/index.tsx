    ...
    <>
      <div className="xl:flex mt-8 justify-between">
        ...
        <div className="xl:w-1/2 mt-8 xl:mt-0">
          ...
          <div className="text-3xl text-white mt-4 font-semibold">Hegemony</div>
          <div className="flex md:w-1/2 justify-between text-white mt-5">
            <div>
              <div className="text-gray-300 text-sm">Total quantity</div>
              <div className="font-semibold">1000</div>
            </div>
            <div>
              <div className="text-gray-300 text-sm">Remaining quantity</div>
              <div className="font-semibold">1000</div>
            </div>
          </div>
          ...
          <div className=" xl:flex mt-8">
            <div className="">
              <div className="flex justify-center xl:justify-start text-gray-300 text-sm text-gray-200">Price</div>
              <div className="text-4xl text-white font-semibold flex justify-center xl:justify-start">
                48.8 BUSD
                <div className="text-sm mt-3 ml-2">$48.79024</div>
              </div>
            </div>
            <div className="mt-3 xl:mt-0 md:ml-5">
              <div>
                <div className="text-gray-300  flex justify-center xl:justify-start  text-sm ">Sale starts in</div>
              </div>
              <div className=" flex justify-center xl:justify-start text-white text-3xl">00:00:00:00</div>
            </div>
          </div>
          <div className="mt-8">
            <div className="text-gray-300 text-sm text-gray-200">Contract Address</div>
          ...
          <div className="">
            <button className=" py-1.5 mt-8 w-full xl:w-64  rounded-lg bg-indigo-500">Buy now</button>
          </div>
        </div>
      </div>
    </>
...
const DetailsTable = () => {
  ...
  const Description = {
    ...
    h1:
      'Wrath of Conquerors: Hegemony is a brand new massive online game running on the Binance Smart Chain (BSC). Players will play the role of a mid-earth lord, recruit heroes, challenge PVP/PVE, level up in the game, obtain treasure chest fragments to synthesize NFT treasure chests.\n' +
      'Potion\n' +
  ...
  return (
    <>
      <div className="shadow overflow-auto border-b mt-20  border-gray-600 sm:rounded-lg">
        <div className="text-white text-xl  flex p-3  font-semibold">Series Content</div>
          ...
          <tbody className=" divide-y divide-gray-600">
            {tableDetail.map(item => (
              <tr key={item.name} className="hover:bg-gray-800">
                <td className="px-6 py-6 whitespace-nowrap text-sm text-white">{item.name}</td>
                <td className="px-6 py-4 whitespace-nowrap text-base text-white">{item.rarity}</td>
                <td className="px-6 py-4 whitespace-nowrap text-base text-white">{item.amount}</td>
                <td className="px-6 py-4 whitespace-nowrap text-base text-white">{item.probability}</td>
              </tr>
            ))}
          </tbody>
        </table>
