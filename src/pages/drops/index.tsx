...
const DropsList = () => {
  ...
  return (
    <>
      <div className="mt-20">
        <div className="mb-10 text-white text-3xl">Drops List</div>
          ...
          {list.map(item => (
            <Link passHref key={item.name} href="/drops/details">
              ...
              <div className="transform  hover:scale-105 transition duration-300">
                ...
                <div className="text-gray-100 text-xl my-3 truncate  font-semibold">{item.name}</div>
                <div className="text-gray-400 text-sm mb-4 md:mb-2 xl:mb-4">{item.time}</div>
                <div className="flex justify-between  mb-4 md:mb-2 xl:mb-4">
                  <div className="text-gray-400 text-sm font-semibold ">Total Supply</div>
                  <div className="text-white text-sm font-semibold">{item.total}</div>
                </div>
                <div className="flex justify-between  mb-6 md:mb-2 xl:mb-6">
                  <div className="text-gray-400 text-sm font-semibold">Mint Price</div>
                  <div className="text-white text-sm font-semibold">{item.mint}</div>
                </div>
              </div>
              {/* </a> */}
            </Link>
            ...
            <div className="relative px-4 py-16 sm:px-6 sm:py-24  mx-auto">
              <div className="text-center">
                ...
                <span className="block text-2xl text-gray-300">
                  Exclusive NFT offerings from the worlds best creators
                </span>
              </div>
            </div>
          </div>
                  ...
                  <div key={item.name} className="lg:flex">
                    ...
                    <div className="mx-auto mt-5 lg:mt-0 md:ml-8">
                      <div className="flex mb-4">
                        ...
                        <div className="text-gray-100 text-2xl mt-3 ml-3 font-semibold">{item.name}</div>
                      </div>
                      <div className="text-gray-400 mb-4 md:mb-2 xl:mb-4">{item.time}</div>
                      <div className="text-gray-300  text-xl mb-6  font-light h-28 overflow-auto ">{item.h1}</div>
                      <div className="md:flex justify-between ">
                        <div className=" flex justify-between md:w-5/12 mb-4 ">
                          <div className="text-gray-400 font-semibold ">Total Supply</div>
                          <div className="text-white font-semibold">{item.total}</div>
                        </div>
                        <div className=" flex justify-between md:w-5/12 mb-6 ">
                          <div className="text-gray-400 font-semibold">Mint Price</div>
                          <div className="text-white font-semibold">{item.mint}</div>
                        </div>
                      </div>
