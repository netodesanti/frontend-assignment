        ...
        <div className=" mx-auto  ">
          <div className="max-w-7xl relative px-5 py-16  sm:px-6   mx-auto ">
            <div className="text-center border-b border-[#325253] pb-8">
              ...
              <button className="text-[#74C7C7] text-sm font-semibold">Learn more</button>
            </div>
                    ...
                    <div className="mx-auto w-full max-w-md">
                      <RadioGroup value={selected} onChange={setSelected}>
                        <div className="flex items-center">
                          <div className="text-neutral-400 font-medium text-sm mr-2">Sort by</div>
                          {farmType.map(type => (
                            <RadioGroup.Option
                              key={type.name}
                              value={type}
                                  ...
                                  <div className="flex w-full items-center justify-between">
                                    <div className="flex items-center">
                                      <div className="text-sm">
                                        <RadioGroup.Label
                                          as="p"
                                          className={`font-medium  ${checked ? 'text-white' : 'text-neutral-400'}`}
                                        >
                                          {type.name}
                                        </RadioGroup.Label>
                                      </div>
                  ...
                  <div key={items.id} className="rounded-lg   bg-gradient-to-b from-[#7ADFD6]/80  to-[#6A91E7]/80">
                    <div className="pb-5 p-4">
                      ...
                      <div className="flex my-2 font-semibold">
                        <div>{items.tokenName1}</div>-<div>{items.tokenName2}</div>
                      </div>
                      <div className="flex">
                        <div className="rounded-md bg-[#FFFFFF]/30 p-1 flex items-center pr-4">
                          ...
                          <img
                            className="w-5 rounded-full border border-[#76FFFF] -ml-0.5"
                            src={items.tokenImg2}
                            alt=""
                          />
                          <div className="ml-2 text-xs">$ {items.tokenWeek} / week</div>
                        </div>
                      </div>
                    </div>
                    <div className="flex justify-between p-4 bg-[#1D1D1D]/80 text-xs">
                      <div className="">
                        <div className="text-gray-500 mb-2">Total Staked</div>
                        <div>${items.totalStaked}</div>
                      </div>
                      <div className="">
                        <div className="text-gray-500 mb-2">APR</div>
                        <div>{items.apr}%</div>
                      </div>
                    </div>
                  </div>
