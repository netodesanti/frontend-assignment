              ...
              <div className="text-white p-2 bg-gray-700 rounded-xl">
                ...
                <div className="p-1 pt-3 px-2">
                  <div className="flex justify-between">
                    <div className="flex">
                      <img className="rounded-full w-6 mr-2" src={item.avatar} alt="" />
                      <div className="tex">{item.name}</div>
                    </div>
                    <div className="flex  ">
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <div className="w-16 truncate">{item.address}</div>
                  </div>
                </div>
              </div>
              {/* </a> */}
            ...
            <div className="max-w-5xl relative px-5 py-16  sm:px-6  mx-auto ">
              <div className=" mx-4 lg:mx-28">
                <div className="text-center">
                  ...
                  <div className=" text-white font-semibold">Wonderland and the Funny Fellows</div>
                </div>
                <div className="mt-7 ">
                  ...
                  <div className="px-4 md:px-8 lg:px-16 py-4 md:flex justify-between rounded-b-xl bg-gradient-to-r from-gray-500 to-gray-700">
                    <div className="mb-3 md:mb-0 flex text-gray-100">
                      ...
                      <div className="flex">
                        ...
                        <div className="text-red-400 mt-1">0</div>
                      </div>
                    </div>
